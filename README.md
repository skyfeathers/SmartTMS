...
**在线预览**
- 管理端：[https://lab.tms.1024lab.net/admin/](https://lab.tms.1024lab.net/admin/#/login?showMode=preview) 用户名：13700000001 / 789321
- 移动端：[https://lab.tms.1024lab.net/h5/](https://lab.tms.1024lab.net/h5/pages/login/login?showMode=preview)
...
#### 移动端
- **登录**: 平台员工、司机登录
- **审批列表**: 运单审批、油卡审批、应付审批、应收审批、在途费用审批
- **通知公告**: 平台推送各端通知信息展示
- **订单管理**: 订单列表、发布、详情，指派司机、复制、取消订单
- **运单管理**: 运单列表、详情、装货、卸货、费用修改、提交结算、作废
- **司机管理**: 司机数据管理、证件审核
- **车辆管理**: 车辆数据管理、证件审核
- **挂车管理**: 挂车数据管理、证件审核
- **在途费用申请**: 现金出车款申请、油卡充值申请
- **在途费用上报**: 现金消费（修车费、违章、住宿、停车等）、ETC（ETC卡支付、现金支付）、油费（现金加油、油卡加油）、尿素（现金支付、油卡支付）
### 项目截图
<table>
<tr>
