...
1. **登记备案**：前往 [👉 商业使用登记专用 Issue](https://gitee.com/lab1024/SmartTMS/issues/IHT0FE) 按格式提交登记。未登记的使用将被视为违反协议。
2. **保留署名**：在系统界面底部或“关于”中保留：“**核心技术由 [智运TMS（SmartTMS），网址：https://gitee.com/lab1024/SmartTMS](https://gitee.com/lab1024/SmartTMS) 提供**”。
