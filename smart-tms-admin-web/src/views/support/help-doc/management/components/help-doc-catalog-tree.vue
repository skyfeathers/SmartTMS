...
<template>
  <a-card class="tree-container" size="small">
    ...
    <a-row class="sort-flag-row" v-if="props.showMenu">
      ...
      <a-button type="primary" @click="addTop" size="small">新建</a-button>
    </a-row>
    <a-tree
        ...
        <a-popover placement="right" v-if="props.showMenu">
          <template #content>
            <div style="display: flex; flex-direction: column">
              <a-button type="text" @click="addHelpDocCatalog(item.dataRef)" v-privilege="'helpDocCatalog:add'">添加下级</a-button>
