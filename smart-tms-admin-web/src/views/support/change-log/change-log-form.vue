  ...
  >
    <a-form ref="formRef" :label-col="{ span: 5 }" :model="form" :rules="rules">
      <a-form-item label="版本" name="version">
        <a-input v-model:value="form.version" placeholder="版本" style="width: 100%" />
      </a-form-item>
      <a-form-item label="更新类型" name="type">
        <SmartEnumSelect v-model:value="form.type" enumName="CHANGE_LOG_TYPE_ENUM" placeholder="更新类型" width="100%" />
      </a-form-item>
      <a-form-item label="发布人" name="publishAuthor">
        <a-input v-model:value="form.publishAuthor" placeholder="发布人" style="width: 100%" />
      </a-form-item>
      <a-form-item label="发布日期" name="publicDate">
        <a-date-picker v-model:value="form.publicDate" placeholder="发布日期" style="width: 100%" valueFormat="YYYY-MM-DD" />
      </a-form-item>
      <a-form-item label="跳转链接" name="link">
        <a-input v-model:value="form.link" placeholder="跳转链接" style="width: 100%" />
      </a-form-item>
      <a-form-item label="更新内容" name="content">
        <a-textarea v-model:value="form.content" :rows="15"  placeholder="更新内容" style="width: 100%" />
      </a-form-item>
    </a-form>
