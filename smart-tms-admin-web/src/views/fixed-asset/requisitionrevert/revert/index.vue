...
<template>
  ...
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      ...
      <a-form-item class="smart-query-form-item" label="退还时间">
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      ...
      <div class="smart-table-setting-block">
        <SmartTableOperator v-model="columns" :tableId="TABLE_ID_CONST.ASSET_REVERT" :refresh="queryData"/>
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
...
async function queryData () {
  ...
  try {
    let queryResult = await assetRevertApi.queryPage(queryForm);
...
function operate ({ requisitionRevertId }) {
  router.push({
    path: '/fixed-asset/revert-operate',
    query: {
      requisitionRevertId
    }
  });
...
function detail ({ requisitionRevertId }) {
  router.push({
    path: '/fixed-asset/revert-detail',
    query: {
      requisitionRevertId
    }
  });
