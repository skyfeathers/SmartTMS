<template>
  <!---------- 查询表单form begin ----------->
  <a-form class="smart-query-form" v-privilege="'consumablesCheck:query'">
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      <div class="smart-table-operate-block">
        <a-button @click="operate" v-privilege="'consumablesCheck:add'" type="primary" size="small">
          <template #icon>
            <PlusOutlined/>
          </template>
          新建
...
async function queryData () {
  ...
  try {
    let queryResult = await consumablesCheckApi.queryPage(queryForm);
