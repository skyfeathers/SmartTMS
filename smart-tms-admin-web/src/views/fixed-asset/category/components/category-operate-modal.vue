  ...
  >
    ...
    >
      <a-form-item label="分类名称" name="categoryName">
        <a-input v-model:value="form.categoryName" placeholder="请输入分类名称" style="width: 200px"/>
      </a-form-item>
      <a-form-item label="顺序" name="sort">
        <a-input-number v-model:value="form.sort" placeholder="请输入顺序" style="width: 200px"/>
      </a-form-item>
      <a-form-item label="顺序" name="disabledFlag">
