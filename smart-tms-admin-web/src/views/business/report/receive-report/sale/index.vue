<template>
  <a-form class="smart-query-form" v-privilege="'saleReceiveReport:query'">
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    <a-row class="smart-table-btn-block">
      <div class="smart-table-operate-block">
        <a-button @click="exportExcel" v-privilege="'saleReceiveReport:export'" size="small">导出</a-button>
      </div>
...
async function ajaxQuery () {
  try {
    ...
    let responseModel = await waybillReportApi.queryAmountBySale(queryForm);
...
function exportExcel(){
  SmartLoading.show();
  waybillReportApi.downloadAmountBySale(queryForm);
  SmartLoading.hide();
}
onMounted(ajaxQuery);
</script>
