<template>
  <a-form class="smart-query-form" v-privilege="'oilCardRate:query'">
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    <a-row class="smart-table-btn-block">
      <div class="smart-table-operate-block">
        <a-button @click="exportExcel" v-privilege="'oilCardRate:export'" size="small">导出</a-button>
      </div>
...
async function ajaxQuery () {
  try {
    ...
    let responseModel = await waybillReportApi.queryOilCardAmountBySale(queryForm);
...
function exportExcel(){
  SmartLoading.show();
  waybillReportApi.downloadOilCardAmountBySale(queryForm);
  SmartLoading.hide();
}
onMounted(ajaxQuery);
</script>
