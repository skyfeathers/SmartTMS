        ...
        <a-col :span="12">
          <a-form-item label="总公里数" name="gpsMileage">
            <a-input-number v-model:value="form.gpsMileage" :min="0" :precision="2"
                            placeholder="请输入总公里数" style="width: 200px"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="用油量" name="oilConsumption">
...
const rules = {
  highSpeedMileage: [{ required: true, message: '请输入高速里程' }],
  lowSpeedMileage: [{ required: true, message: '请输入低速里程）' }],
  gpsMileage: [{ required: true, message: '请输入总公里数' }],
