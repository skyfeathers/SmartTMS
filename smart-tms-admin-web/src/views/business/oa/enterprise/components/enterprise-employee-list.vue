<template>
  <div>
    <div class="header">
      ...
      <div>
        <a-button class="button-style" type="primary" @click="addEmployee" size="small" v-privilege="'enterprise:addEmployee'">
          添加员工
        </a-button>
        <a-button class="button-style" type="primary" danger @click="batchDelete" size="small" v-privilege="'enterprise:deleteEmployee'">
          批量移除
        </a-button>
      </div>
    </div>
...
async function queryEmployee() {
  try {
    ...
    let res = await employeeApi.queryEmployee(queryForm);
