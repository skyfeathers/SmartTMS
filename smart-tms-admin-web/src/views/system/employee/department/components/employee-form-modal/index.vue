...
<template>
  ...
  >
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      ...
      <a-form-item label="在职状态" name="leaveFlag">
        <a-select v-model:value="form.leaveFlag" placeholder="请选择在职状态">
...
import {DATA_SCOPE_LEVEL_ENUM} from '/@/constants/system/employee-const';
