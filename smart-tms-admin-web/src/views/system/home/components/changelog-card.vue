...
-->
<template>
  <default-home-card extra="更多" :icon="UpdateIcon" title="更新日志" @extraClick="onMore">
    <a-empty v-if="$lodash.isEmpty(data)" />
    <ul v-else class="changelog-card-list">
...
import UpdateIcon from "/@/assets/images/home/update-icon.png";
