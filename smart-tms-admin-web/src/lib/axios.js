...
let apiUrl = import.meta.env.VITE_APP_API_URL_PREFIX +  import.meta.env.VITE_APP_API_URL_SUFFIX;
if (import.meta.env.VITE_APP_PROFILE != 'dev' && import.meta.env.VITE_APP_PROFILE != 'local') {
    apiUrl = `${location.origin}`+ import.meta.env.VITE_APP_API_URL_SUFFIX;
}

const smartAxios = axios.create({
  baseURL: apiUrl,
  // baseURL: 'http://192.168.1.100:60001/',
});
