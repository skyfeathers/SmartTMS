...
let apiUrl = import.meta.env.VITE_APP_API_URL_PREFIX +  import.meta.env.VITE_APP_FIXED_ASSET_API_URL_SUFFIX;
if (import.meta.env.VITE_APP_PROFILE != 'dev' && import.meta.env.VITE_APP_PROFILE != 'local') {
    apiUrl = `${location.origin}`+ import.meta.env.VITE_APP_FIXED_ASSET_API_URL_SUFFIX;
}
