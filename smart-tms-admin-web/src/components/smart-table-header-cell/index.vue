            ...
            <slot>
                <template v-if="column.filterOptions">
                    ...
                    <template v-else-if="column.filterOptions.type === 'date-range'">
                        <a-range-picker v-model:value="createDateRange"
                        :presets="column.filterOptions.ranges ? defaultTimeRanges : []"
                        style="width: 100%"
                        @change="changeCreateDate" />
                    </template>
                    <template v-else-if="column.filterOptions.type === 'datetime-range'">
                        <a-range-picker show-time v-model:value="createDateRange"
                        :presets="column.filterOptions.ranges ? defaultTimeRanges : []"
                        style="width: 100%"
                        @change="changeCreateDate" />
                    </template>
                    ...
                    <template v-else>
                        <component v-if="componentsKey.includes(column.filterOptions.type)"
...
const components = {
    'enum-select': defineAsyncComponent(() =>import('/@/components/smart-enum-select/index.vue')),
    'dict-select': defineAsyncComponent(() =>import('/@/components/smart-dict-select/index.vue')),
    'driver-select': defineAsyncComponent(() =>import('/@/components/driver-select/index.vue')),
    'vehicle-select': defineAsyncComponent(() =>import('/@/components/vehicle-select/index.vue')),
    'shipper-select': defineAsyncComponent(() =>import('/@/components/shipper-select/index.vue')),
    'business-type-select': defineAsyncComponent(() =>import('/@/components/business-type-select/index.vue')),
    'cabinet-select': defineAsyncComponent(() =>import('/@/components/cabinet-select/index.vue')),
    'role-employee-select': defineAsyncComponent(() =>import('/@/components/role-employee-select/index.vue')),
    'employee-select': defineAsyncComponent(() =>import('/@/components/employee-select/index.vue')),
    'enterprise-select': defineAsyncComponent(() =>import('/@/components/enterprise-select/index.vue')),
    'boolean-select': defineAsyncComponent(() =>import('/@/components/smart-boolean-select/index.vue')),
    'disabled-select': defineAsyncComponent(() =>import('/@/components/smart-disabled-select/index.vue')),
    'role-select': defineAsyncComponent(() =>import('/@/components/role-select/index.vue')),
    'fleet-select': defineAsyncComponent(() =>import('/@/components/fleet-select/index.vue')),
    'number-range': defineAsyncComponent(() =>import('/@/components/smart-input-range/index.vue'))
}
