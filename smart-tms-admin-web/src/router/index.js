...
import { PAGE_PATH_404, PAGE_PATH_HOME, PAGE_PATH_LOGIN, PAGE_PATH_STATISTIC } from '/@/constants/common-const';
...
export function buildRoutes(menuRouterList) {
  ...
  const modulesEager = import.meta.glob('../views/**/**.vue', { eager: true });
