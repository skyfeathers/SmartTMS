...
public class SystemEnvironmentConfig implements Condition {
    ...
    public boolean matches(ConditionContext conditionContext, AnnotatedTypeMetadata annotatedTypeMetadata) {
        ...
        return StringUtils.isNotBlank(property) && !SystemEnvironmentEnum.PROD.equalsValue(property)  && !SystemEnvironmentEnum.HCL_PROD.equalsValue(property)  && !SystemEnvironmentEnum.SASS.equalsValue(property);
    }
    ...
    public SystemEnvironment initEnvironment() {
        ...
        return new SystemEnvironment(SystemEnvironmentEnum.isProd(systemEnvironment), projectName, redisProjectName, currentEnvironment);
    }
}
