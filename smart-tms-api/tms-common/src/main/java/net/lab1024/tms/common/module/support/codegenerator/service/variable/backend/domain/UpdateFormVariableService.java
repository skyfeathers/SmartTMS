package net.lab1024.tms.common.module.support.codegenerator.service.variable.backend.domain;
...
import net.lab1024.tms.common.module.support.codegenerator.domain.model.CodeField;
import net.lab1024.tms.common.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
import net.lab1024.tms.common.module.support.codegenerator.domain.model.CodeInsertAndUpdateField;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import net.lab1024.tms.common.common.swagger.ApiModelPropertyEnum;");
                packageList.add("import net.lab1024.tms.common.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import net.lab1024.tms.common.common.json.deserializer.DictValueVoDeserializer;");
            }
            ...
            if (SmartStringUtil.contains(field.getFrontComponent(), "Upload")) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import net.lab1024.tms.common.common.json.deserializer.FileKeyVoDeserializer;");
            }
