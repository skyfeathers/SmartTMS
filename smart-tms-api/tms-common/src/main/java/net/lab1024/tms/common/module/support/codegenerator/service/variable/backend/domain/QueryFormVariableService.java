...
import net.lab1024.tms.common.module.support.codegenerator.constant.CodeQueryFieldQueryTypeEnum;
...
import net.lab1024.tms.common.module.support.codegenerator.domain.model.CodeQueryField;
...
public class QueryFormVariableService extends CodeGenerateBaseVariableService {
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(CodeGeneratorConfigForm form) {
        ...
        for (CodeQueryField field : fields) {
            ...
            CodeQueryFieldQueryTypeEnum queryTypeEnum = SmartBaseEnumUtil.getEnumByValue(queryTypeEnumStr, CodeQueryFieldQueryTypeEnum.class);
