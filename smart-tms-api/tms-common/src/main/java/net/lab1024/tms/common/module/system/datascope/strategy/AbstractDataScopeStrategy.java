package net.lab1024.tms.common.module.system.datascope.strategy;
...
public abstract class AbstractDataScopeStrategy {
     ...
     * 获取joinsql 字符串
     */
    public abstract String getCondition(Long enterpriseId, Long employeeId, Map<String, Object> paramMap, DataScopeSqlConfig sqlConfigDTO);
}
