package net.lab1024.tms.common.module.support.codegenerator.service.variable.backend;

import com.google.common.base.CaseFormat;
import net.lab1024.tms.common.common.util.SmartBaseEnumUtil;
import net.lab1024.tms.common.module.support.codegenerator.constant.CodeDeleteEnum;
...
public class ControllerVariableService extends CodeGenerateBaseVariableService {
    ...
    public List<String> getPackageList(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        if (form.getDeleteInfo().getIsSupportDelete()) {
            ...
            CodeDeleteEnum codeDeleteEnum = SmartBaseEnumUtil.getEnumByValue(form.getDeleteInfo().getDeleteEnum(), CodeDeleteEnum.class);
            if (codeDeleteEnum == CodeDeleteEnum.BATCH || codeDeleteEnum == CodeDeleteEnum.SINGLE_AND_BATCH) {
                //2、批量删除的话，要导入ValidateList
                packageSet.add("import net.lab1024.tms.common.common.domain.ValidateList;");
            }
