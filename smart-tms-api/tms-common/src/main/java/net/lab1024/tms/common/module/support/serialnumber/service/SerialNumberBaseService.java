...
import net.lab1024.tms.common.module.support.serialnumber.dao.SerialNumberDao;
import net.lab1024.tms.common.module.support.serialnumber.dao.SerialNumberRecordDao;
import net.lab1024.tms.common.module.support.serialnumber.domain.*;
...
public abstract class SerialNumberBaseService implements SerialNumberService {
    ...
    void init() {
        ...
        for (SerialNumberEntity serialNumberEntity : serialNumberEntityList) {
            SerialNumberRuleTypeEnum ruleTypeEnum = SmartBaseEnumUtil.getEnumByName(serialNumberEntity.getRuleType().toUpperCase(), SerialNumberRuleTypeEnum.class);
