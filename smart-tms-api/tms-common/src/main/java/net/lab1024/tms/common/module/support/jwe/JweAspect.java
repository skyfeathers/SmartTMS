...
public class JweAspect {
    ...
    @Before("@annotation(net.lab1024.tms.common.module.support.jwe.JweDecrypt)")
    ...
    @AfterReturning(returning = "object", pointcut = "@annotation(net.lab1024.tms.common.module.support.jwe.JweEncrypt)")
