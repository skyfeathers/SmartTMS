...
import net.lab1024.tms.common.module.system.department.CommonDepartmentService;
...
import net.lab1024.tms.common.module.system.role.CommonRoleEmployeeDao;
import net.lab1024.tms.common.module.system.role.CommonRoleDataScopeDao;
import net.lab1024.tms.common.module.system.role.domain.entity.RoleDataScopeEntity;
...
public class DataScopeViewService {
    ...
    @Resource
    private CommonRoleEmployeeDao commonRoleEmployeeDao;

    @Resource
    private CommonRoleDataScopeDao commonRoleDataScopeDao;
    ...
    public List<Long> getMeDepartmentIdList(Long employeeId) {
        EmployeeEntity employeeEntity = commonEmployeeDao.selectById(employeeId);
        return Lists.newArrayList(employeeEntity.getDepartmentId());
    }

    public List<Long> getDepartmentAndSubIdList(Long employeeId) {
        EmployeeEntity employeeEntity = commonEmployeeDao.selectById(employeeId);
        return commonDepartmentService.selfAndChildrenIdList(employeeEntity.getDepartmentId());
    }
    ...
    public DataScopeViewTypeEnum getEmployeeDataScopeViewType(DataScopeTypeEnum dataScopeTypeEnum, Long employeeId) {
        ...
        List<Long> roleIdList = commonRoleEmployeeDao.selectRoleIdByEmployeeId(employeeId);
        //未设置角色 默认本人
        if (CollectionUtils.isEmpty(roleIdList)) {
            return DataScopeViewTypeEnum.ME;
        }
        //未设置角色数据范围 默认本人
        List<RoleDataScopeEntity> dataScopeRoleList = commonRoleDataScopeDao.listByRoleIdList(roleIdList);
    ...
    private List<Long> getDepartmentEmployeeIdList(Long employeeId) {
        EmployeeEntity employeeEntity = commonEmployeeDao.selectById(employeeId);
        return commonEmployeeDao.getEmployeeIdByDepartmentId(employeeEntity.getDepartmentId(), false);
    }
    ...
    private List<Long> getDepartmentAndSubEmployeeIdList(Long employeeId) {
        ...
        return commonEmployeeDao.getEmployeeIdByDepartmentIdList(allDepartmentIds, false);
    }
}
