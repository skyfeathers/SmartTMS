package net.lab1024.tms.admin.module.business.carcost.oilcardreceive.domain;
 ...
 */
@Data
public class CarCostOilCardReceiveAuditForm {

    @ApiModelProperty("油卡收入ID")
    @NotNull(message = "油卡收入ID不能为空")
