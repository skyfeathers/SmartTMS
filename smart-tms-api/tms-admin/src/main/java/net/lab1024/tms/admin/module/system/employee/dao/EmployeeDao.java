...
import net.lab1024.tms.admin.module.system.employee.domain.form.EmployeeQueryForm;
...
public interface EmployeeDao extends BaseMapper<EmployeeEntity> {
     ...
     * @return
     */
    List<EmployeeEntity> queryAll(@Param("disabledFlag") Boolean disabledFlag, @Param("deletedFlag") Boolean deletedFlag);
     ...
     * @return
     */
    EmployeeEntity getByLoginName(@Param("enterpriseId") Long enterpriseId, @Param("loginName") String loginName,
     ...
     * @return
     */
    EmployeeEntity getByActualName(@Param("enterpriseId") Long enterpriseId, @Param("actualName") String actualName,
                                   @Param("disabledFlag") Boolean disabledFlag
    );
     ...
     * @return
     */
    EmployeeEntity getByPhone(@Param("enterpriseId") Long enterpriseId, @Param("phone") String phone, @Param("disabledFlag") Boolean disabledFlag);
    ...
    Integer countByEnterpriseId(@Param("enterpriseId") Long enterpriseId, @Param("deletedFlag") Boolean deletedFlag);
    /**
     * 获取一批员工
     *
     * @param employeeIds
     ...
     * @return
     */
    List<Long> getEmployeeId(@Param("enterpriseId") Long enterpriseId, @Param("leaveFlag") Boolean leaveFlag, @Param("disabledFlag") Boolean disabledFlag);
     ...
     * 根据姓名查询
     *
     * @param actualNameList
     * @param disabledFlag
     * @return
     */
    List<EmployeeEntity> selectByActualNameList(@Param("enterpriseId") Long enterpriseId, @Param("actualNameList") Collection<String> actualNameList, @Param("disabledFlag") Boolean disabledFlag, @Param("deletedFlag") Boolean deletedFlag);
     ...
     * @return
     */
    List<EmployeeVO> selectByDepartmentIds(@Param("departmentIdList") List<Long> departmentIdList, @Param("disabledFlag") Boolean disabledFlag, @Param("deletedFlag") Boolean deletedFlag);
