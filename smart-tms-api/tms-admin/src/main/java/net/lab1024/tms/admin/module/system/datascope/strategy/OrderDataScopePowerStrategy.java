 ...
 *
 * @author lidoudou
 * @date 2022/11/10 上午9:03
 */
@Component
public class OrderDataScopePowerStrategy extends AbstractDataScopeStrategy {

    private static String JOIN_SQL = " (o.create_user_id in (#employeeIds) or o.schedule_id in (#employeeIds))";

    /**
     * 客服的拼接sql
     */
    private static String CUSTOMER_SERVICE_JOIN_SQL = " o.create_user_id in (#employeeIds)";
