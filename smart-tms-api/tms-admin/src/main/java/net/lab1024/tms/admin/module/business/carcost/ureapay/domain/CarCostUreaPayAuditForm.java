package net.lab1024.tms.admin.module.business.carcost.ureapay.domain;
 ...
 */
@Data
public class CarCostUreaPayAuditForm {

    @ApiModelProperty("尿素支出ID")
    @NotNull(message = "尿素支出ID不能为空")
