 ...
 */
@Data
public class ConsumablesConsumablesCheckDetailVO extends ConsumablesCheckVO {
    ...
    @ApiModelProperty("易耗品清单明细")
    private List<ConsumablesCheckItemVO> itemList;

    @ApiModelProperty("盘点员工")
    private List<ConsumablesCheckEmployeeVO> employeeList;
