...
@Mapper
@Component
public interface TransferItemDao extends BaseMapper<TransferItemEntity> {
     ...
     * @return
     */
    List<TransferItemEntity> queryByTransferIdList(@Param("transferIdList") List<Long> transferIdList);
}
